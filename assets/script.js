(function () {
	...
	onvisible.add(".image.style1", { style: "tilt-right", speed: 1375, intensity: 3, delay: 375, staggerOrder: "", state: true, replay: false });
	onvisible.add("#text01", { style: "fade-up", speed: 1000, intensity: 2, delay: 750, staggerOrder: "", state: true, replay: false });
	onvisible.add("h1.style3, h2.style3, h3.style3, p.style3", { style: "fade-down", speed: 1000, intensity: 2, delay: 750, staggerOrder: "", state: true, replay: false });
	onvisible.add(".buttons.style1", { style: "zoom-out", speed: 500, intensity: 0, delay: 1125, stagger: 125, state: true, replay: false });
	onvisible.add(".buttons.style2", { style: "fade-up", speed: 500, intensity: 5, delay: 1375, stagger: 125, state: true, replay: false });
	onvisible.add(".image.style2", { style: "zoom-in", speed: 750, intensity: 3, delay: 1500, staggerOrder: "", state: true, replay: false });
	onvisible.add(".buttons.style3", { style: "fade-up", speed: 500, intensity: 3, delay: 1750, stagger: 125, state: true, replay: false });
})();
